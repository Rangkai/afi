...
<GridContainer>
  ...
  <GridItem>
    ...
    <p className="caption">Masitah Fitria Ningrum</p>

    Kota Balikpapan terkenal dengan industri minyak. Hal itu ditandai dalam sejarah
...
<GridContainer>
  <GridItemLeftContent>
    <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'balikpapan1')} alt={'Balikpapan 1'}>
      <SquareImage image={props.data.gallery.nodes.find(item => item.name === 'balikpapan1')} alt={'Balikpapan 1'} mb="16px" />
    </Lightbox>
    <p className="caption">Sekarang Kita Jalan Bersama</p>
  </GridItemLeftContent>
  <GridItem>
...
<GridContainer>
  <GridItemLeftContent>
    <p className="info">Jumlah Anggota (%)</p>
    <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'Jumlah-Anggota')} alt={'Jumlah-Anggota'} mb="16px" size="xl">
      <GatsbyImage image={getImage(props.data.gallery.nodes.find(item => item.name === 'Jumlah-Anggota-thumb'))} alt={'Jumlah-Anggota-thumb'} noBorder />
    </Lightbox>
    <p className="caption">Terdapat dua pola kecondongan dalam
      jumlah range anggota komunitas, yaitu
      komunitas berskala kecil, yaitu berjumlah
      1 - 6 orang (40%), atau komunitas berskala
      besar, yaitu berjumlah lebih dari 25 orang
      (28%). -Dari 22 komunitas yang memiliki
      anggota lebih dari 25 orang, mayoritas
      komunitas tersebut berbadan hukum (91%),
      produksi (64%), dan berstatus pelajar (50%)
      atau mahasiswa (55%).</p>
  </GridItemLeftContent>
  <GridItem>
...
<GridContainer>
  <GridItemLeftContent>
    <p className="info">Anggota Komunitas (%)</p>
    <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'Anggota-Komunitas')} alt={'Anggota-Komunitas'} mb="16px" size="2xl">
      <GatsbyImage image={getImage(props.data.gallery.nodes.find(item => item.name === 'Anggota-Komunitas-thumb'))} alt={'Anggota-Komunitas-thumb'} noBorder />
    </Lightbox>
    <p className="caption">Siapa anggota komunitas? Pertanyaan itu
      mudah dijawab bila suatu komunitas film
      merupakan bagian dari sebuah institusi
      pendidikan. Komunitas film pelajar hampir
      bisa ditemui di sekolah dan perguruan
      tinggi yang memiliki program studi atau
      mata kuliah terkait media dan perfilman.
      Sebagian komunitas lainnya beranggotakan
      individu-individu yang juga tidak serta merta
      memiliki profesi di dunia perfilman.</p>
  </GridItemLeftContent>
  <GridItem>
...
<GridContainer>
  <GridItemLeftContent>
    <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'balikpapan2')} alt={'Balikpapan 2'}>
      <SquareImage image={props.data.gallery.nodes.find(item => item.name === 'balikpapan2')} alt={'Balikpapan 2'} mb="16px" />
    </Lightbox>
    <p className="caption">Sekarang Kita Jalan Bersama</p>
  </GridItemLeftContent>
  <GridItem>
...
<GridContainer>
  <GridItemLeftContent>
    <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'balikpapan3')} alt={'balikpapan 3'}>
      <SquareImage image={props.data.gallery.nodes.find(item => item.name === 'balikpapan3')} alt={'balikpapan 3'} mb="16px" />
    </Lightbox>
    <p className="caption">Target Lima Juta</p>
  </GridItemLeftContent>
  <GridItem>
...
<GridContainer>
  <GridItemLeftContent>
    ...
    <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'Perektrutan-Anggota')} alt={'Perektrutan-Anggota'} mb="16px" size="2xl">
      <GatsbyImage image={getImage(props.data.gallery.nodes.find(item => item.name === 'Perektrutan-Anggota-thumb'))} alt={'Perektrutan-Anggota-thumb'} noBorder />
    </Lightbox>
    <p className="caption">Sebagian komunitas yang terdata mengakui
      bahwa rekrutmen anggota tidak berjalan.
      Beberapa mengadakan rekrutmen anggota
      hanya ketika ada kegiatan. Perihal
      regenerasi ini bisa menjadi persoalan untuk
      keberlanjutan komunitas dalam jangka
      panjang</p>
  </GridItemLeftContent>
  <GridItem>
...
<SimpleGrid columns={[1, null, 2]} spacingX={34} spacingY={10}>
  <ImagePlay href="https://rangkai.id/?browse=308">
    <Box 
  ...
  <ImagePlay href="https://rangkai.id/?browse=307">
    <Box 
  ...
  <ImagePlay href="https://rangkai.id/?browse=281">
    <Box 
