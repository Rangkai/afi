...
graphFile: 'GrafikData_Balikpapan.pdf'
position: {
  left: 46%,
  bottom: 61%
}
...
<GridContainer>
  <GridItem>
    ...
    <Box as={GatsbyImage} mb="8px" mt="50px" image={getImage(props.data.gallery.nodes.find(item => item.name === '20220614_174748BW'))} alt="balikpapan 1" />
    ...
    <Box as={GatsbyImage} mb="8px" mt="50px" image={getImage(props.data.gallery.nodes.find(item => item.name === '20220614_134252BW'))} alt="balikpapan 2"/>
    <Text className="caption" mb="50px !important">Sekarang Kita Jalan Bersama</Text>
    ...
    <Box as={GatsbyImage} mb="8px" mt="50px" image={getImage(props.data.gallery.nodes.find(item => item.name === '20211020112147_IMG_5086BW'))} alt="balikpapan 3" />
...
<Text mb={["10px !important", null, "0px !important"]} as="h3" textTransform="uppercase" fontWeight="400 !important"> Balikpapan </Text>
...
<SimpleGrid columns={[1, null, 3]} spacingX={34} spacingY={10}>
  <Box 
    as={GatsbyImage} image={getImage(props.data.gallery.nodes.find(item => item.name === 'Balada Romansa Bujang_Nocturne Films_1920-1080 - Ihsan AditamaBW'))}
    alt={'Balada Romansa Bujang_Nocturne Films_Ihsan Aditama'}
  />
  <Box 
    as={GatsbyImage} image={getImage(props.data.gallery.nodes.find(item => item.name === 'Four Horsemen_Nocturne Films_1920-1080 - Ihsan AditamaBW'))}
    alt={'Four Horsemen_Nocturne Films_Ihsan Aditama'}
  />
  <Box 
    as={GatsbyImage} image={getImage(props.data.gallery.nodes.find(item => item.name === 'target-5-juta-thumbnail-masterBW'))}
