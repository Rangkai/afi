...
<SimpleGrid columns={[1, null, 2]} spacingX={34} spacingY={10}>
  ...
  <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'selected2')} alt={'the image book'}>
    <Box 
  ...
  <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'selected3')} alt={'tout va bien'}>
    <Box 
  ...
  <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'selected4')} alt={'la chinoise'}>
    <Box 
  ...
  <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'selected5')} alt={'weeken'}>
    <Box 
  ...
  <Lightbox image={props.data.gallery.nodes.find(item => item.name === 'selected6')} alt={'masculin feminin'}>
    <Box 
