...
desc: Berkenalan dengan Insan Perfilman di Kota Balikpapan
banner: '../images/cities/balikpapan/banner.jpg'
thumb: '../images/cities/balikpapan/balikpapan3.JPG'
...
<GridContainer>
  <GridItemLeftContent>
    ...
    <p className="caption">Is solorepudi cor rem autem dicia qui sitiam et vernatur? Qui totatus rerum faceri</p>
  </GridItemLeftContent>
  <GridItem>
...
<GridContainer>
  <GridItemLeftContent>
    ...
    <p className="caption">Git enimpores ipsandae es uta qui blab iniet faccae soluptatem quis sunt, que cum</p>
  </GridItemLeftContent>
  <GridItem>
...
<GridContainer>
  <GridItemLeftContent>
    ...
    <p className="caption">Icae provitaspis senime voluptis mi, se pe suntem eatio. Etus ipsamus dolupti</p>
  </GridItemLeftContent>
  <GridItem>
